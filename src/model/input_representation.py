...
from constants import STOPWORDS, nltk_stopwords
# stopword_dict=nltk_stopwords
...
def pos_tag_spacy(text, en_model):
...
# =============================================================================
        self.tokens, self.tags, self.tokens_tagged = pos_tag_spacy(text, en_model)
